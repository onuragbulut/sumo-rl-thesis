...
sns.set(style='darkgrid', rc={'figure.figsize': (10.8, 6.675),#(7.2, 4.45),
                            'text.usetex': False,
                            'xtick.labelsize': 16,
                            'ytick.labelsize': 16,
                            'font.size': 15,
...
if __name__ == '__main__':
    ...
    prs.add_argument('-f2', nargs='+', help="Measures files\n")
    prs.add_argument('-f3', nargs='+', help="Measures files\n")
