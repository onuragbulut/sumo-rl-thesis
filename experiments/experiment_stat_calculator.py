...
for scenario in range(1, 9):
    csv_output_file_path = '../outputs/DE-Enhanced-S3/DE-Enhanced-S3-Scenario-{}.csv'.format(scenario)
    output_file_content_test = []
    output_file_content_baseline = []
    output_file_header = []

    for index in range(1, 6):
        csv_input_file_path = '../outputs/DE-Enhanced-S3/DE-Enhanced-S3-{}-reduced.csv'.format(index)
